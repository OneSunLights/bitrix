					...
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade" id="expeditions" aria-labelledby="expeditions-tab">
							...
							<div class="col-md-4 col-sm-5 tab-image">
								<img src="<?=SITE_TEMPLATE_PATH?>/images/f2.jpg" class="img-responsive" alt="Wanderer">
							</div>
							<div class="col-md-4 col-sm-5 tab-image">
								<img src="<?=SITE_TEMPLATE_PATH?>/images/f4.jpg" class="img-responsive" alt="Wanderer">
							</div>
							<div class="col-md-4 col-sm-5 tab-image">
								<img src="<?=SITE_TEMPLATE_PATH?>/images/f3.jpg" class="img-responsive" alt="Wanderer">
							</div>
						...
						<div role="tabpanel" class="tab-pane fade" id="safari" aria-labelledby="safari-tab">
							<div class="col-md-4 col-sm-5 tab-image">
								<img src="<?=SITE_TEMPLATE_PATH?>/images/t1.jpg" class="img-responsive" alt="Wanderer">
							</div>
							<div class="col-md-4 col-sm-5 tab-image">
								<img src="<?=SITE_TEMPLATE_PATH?>/images/t2.jpg" class="img-responsive" alt="Wanderer">
							</div>
							<div class="col-md-4 col-sm-5 tab-image">
								<img src="<?=SITE_TEMPLATE_PATH?>/images/t3.jpg" class="img-responsive" alt="Wanderer">
							</div>
							<div class="clearfix"></div>
						</div>
						<div role="tabpanel" class="tab-pane fade active in" id="trekking" aria-labelledby="trekking-tab">
							...
							<div class="col-md-4 col-sm-5 tab-image">
								<img src="<?=SITE_TEMPLATE_PATH?>/images/m2.jpg" class="img-responsive" alt="Wanderer">
							</div>
							<div class="col-md-4 col-sm-5 tab-image">
								<img src="<?=SITE_TEMPLATE_PATH?>/images/m1.jpg" class="img-responsive" alt="Wanderer">
							</div>
							<div class="col-md-4 col-sm-5 tab-image">
								<img src="<?=SITE_TEMPLATE_PATH?>/images/m3.jpg" class="img-responsive" alt="Wanderer">
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
		...
		<div class="tech-no">
			<!-- technology-top -->
			 ...
			 <div class="tc-ch wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
					...
					<div class="tch-img">
						<a href="/"><img src="<?=SITE_TEMPLATE_PATH?>/images/t4.jpg" class="img-responsive" alt=""></a>
					</div>
					
					<h3><a href="/">Lorem Ipsum is simply</a></h3>
					<h6>BY <a href="/">ADAM ROSE </a>JULY 10 2016.</h6>
			...
			<div class="w3ls">
				<div class="col-md-6 w3ls-left wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
					 <div class="tc-ch">
						<div class="tch-img">
							<a href="/">
							<img src="<?=SITE_TEMPLATE_PATH?>/images/m4.jpg" class="img-responsive" alt=""></a>
						</div>
				...
				<div class="col-md-6 w3ls-left wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
					 <div class="tc-ch">
						<div class="tch-img">
							<a href="/"><img src="<?=SITE_TEMPLATE_PATH?>/images/m5.jpg" class="img-responsive" alt=""></a>
						</div>
			...
			<div class="wthree">
				 <div class="col-md-6 wthree-left wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
					<div class="tch-img">
							<a href="/"><img src="<?=SITE_TEMPLATE_PATH?>/images/f1.jpg" class="img-responsive" alt=""></a>
						</div>
				 </div>
			...
			<div class="wthree">
				 <div class="col-md-6 wthree-left wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
					<div class="tch-img">
							<a href="/"><img src="<?=SITE_TEMPLATE_PATH?>/images/f3.jpg" class="img-responsive" alt=""></a>
						</div>
				 </div>
				 <div class="col-md-6 wthree-right wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
						<h3><a href="/">Lorem Ipsum is simply</a></h3>
